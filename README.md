...
| **Tools/Technologies/Environment** |  Swift(5), Azure, Socket.IO, HealthKit, Almaofire, Lottie-Animations, Google Maps, Google Places, Firebase, CoreData, Core-Bluetooth, Knet Payment Method, OpenTok(Video Calling) 
| **Role**               | iOS Developer |
| **Team Size**          | 7 |
